...
The 2-minute rule is powerful: if something takes less than 2 minutes, do it now. For larger tasks, commit to working for just 2 minutes. Often, starting is the hardest part, and momentum carries you forward once you begin.`,
    ...
    quiz: [
      { question: "According to research, what is MORE effective than self-criticism for overcoming procrastination?", options: ["Strict deadlines", "Self-compassion", "External rewards", "Public accountability"], correctIndex: 1, explanation: "Self-compassion reduces negative emotions associated with tasks, making you less likely to avoid them in the future." },
      { question: "What does the '2-minute rule' suggest?", options: ["Take 2-minute breaks every hour", "If a task takes under 2 minutes, do it now", "Meditate for 2 minutes before working", "Wait 2 minutes before checking your phone"], correctIndex: 1, explanation: "The 2-minute rule helps build momentum by completing small tasks immediately, reducing your mental load." }
    ]
  },
  {
    topic: "Finance",
...
Inflation works against you using the same math. At 3% inflation, your purchasing power halves in 24 years. This is why leaving money in a low-interest savings account actually loses value over time—and why investing isn't optional for long-term financial health.`,
    ...
    quiz: [
      { question: "Using the Rule of 72, how long would it take to double your money at 6% annual returns?", options: ["6 years", "8 years", "12 years", "18 years"], correctIndex: 2, explanation: "72 ÷ 6 = 12 years. This simple division gives you a quick estimate for any interest rate." },
      { question: "Why does starting to invest early matter according to the Rule of 72?", options: ["You get better interest rates", "You gain more doubling periods", "Banks prefer younger investors", "Tax benefits expire with age"], correctIndex: 1, explanation: "More time = more doubling periods. A 25-year-old has 8-10 doublings before retirement vs only 4-5 for a 45-year-old." }
    ]
  },
  {
    topic: "Science",
...
On the Moon, with no atmosphere to scatter light, the sky is always black—even during "daytime." Astronauts see stars while standing in direct sunlight. Mars has a thin atmosphere with different particles, creating a butterscotch-colored sky during the day and blue sunsets—the opposite of Earth.`,
    ...
    quiz: [
      { question: "What causes the sky to appear blue?", options: ["Reflection from oceans", "Rayleigh scattering", "Ozone layer absorption", "Water vapor in clouds"], correctIndex: 1, explanation: "Rayleigh scattering causes shorter wavelengths (blue) to scatter more than longer wavelengths as light passes through the atmosphere." },
      { question: "Why isn't the sky violet, even though violet has a shorter wavelength than blue?", options: ["Violet light is absorbed by ozone", "The sun emits less violet and our eyes are less sensitive to it", "Violet is blocked by clouds", "The atmosphere filters out violet"], correctIndex: 1, explanation: "The sun emits less violet light than blue, and human eyes are more sensitive to blue wavelengths." }
    ]
  },
  {
    topic: "Philosophy",
...
Modern psychology confirms this ancient wisdom. Research on "defensive pessimism" shows that anxious people who imagine setbacks actually perform better than those who try to think positively. The key is brief, controlled visualization—not obsessive worry. Spend a few minutes, not hours, and then return to action.`,
    ...
    quiz: [
      { question: "What is the main purpose of the Stoic practice 'premeditatio malorum'?", options: ["To become pessimistic", "To prepare emotionally and appreciate the present", "To predict the future", "To avoid taking risks"], correctIndex: 1, explanation: "Negative visualization helps reduce the emotional impact of potential losses and cultivates gratitude for what you currently have." },
      { question: "According to modern psychology, how does 'defensive pessimism' affect anxious people?", options: ["It makes them more anxious", "It helps them perform better", "It has no effect", "It causes depression"], correctIndex: 1, explanation: "Research shows that anxious people who briefly imagine setbacks actually perform better than those who try forced positive thinking." }
    ]
  },
  {
    topic: "Tech",
...
The "black box" problem remains unsolved. We often can't explain why a model made a specific decision. This matters in high-stakes domains like healthcare or criminal justice. Understanding AI's limitations is as important as appreciating its capabilities—especially as it becomes more integrated into society.`,
    ...
    quiz: [
      { question: "How do machine learning models primarily 'learn'?", options: ["By understanding concepts like humans", "By finding statistical patterns in data", "By being programmed with rules", "By copying human brain structure"], correctIndex: 1, explanation: "ML models find statistical patterns and correlations in massive datasets—they don't truly 'understand' like humans do." },
      { question: "What is the 'black box' problem in AI?", options: ["AI systems are painted black", "We often can't explain why AI made a specific decision", "AI can't see in the dark", "AI systems are too expensive"], correctIndex: 1, explanation: "The black box problem refers to our inability to explain the reasoning behind AI decisions, which is critical in high-stakes domains." }
    ]
  },
  {
    topic: "Business",
...
The technique works across domains. In personal finance, instead of accepting "you need a 20% down payment," ask what problem the down payment solves and whether there are other solutions. In career planning, instead of following the standard path, ask what you actually need to achieve your goals. The answers often surprise you.`,
    ...
    quiz: [
      { question: "What is the main difference between first principles thinking and reasoning by analogy?", options: ["First principles is faster", "First principles breaks down to fundamental truths instead of copying others", "Analogy is more creative", "They are the same thing"], correctIndex: 1, explanation: "First principles thinking starts from fundamental truths and builds up, while analogy copies existing solutions with their limitations." },
      { question: "Why is reasoning by analogy 'terrible for innovation'?", options: ["It's too slow", "You inherit other people's limitations", "It requires too much research", "Analogies are always wrong"], correctIndex: 1, explanation: "When you copy existing solutions, you also copy their constraints and assumptions, limiting breakthrough possibilities." }
    ]
  },
];
...
export default function HomePage() {
  ...
  const handleQuizComplete = (score: number) => {
    // Record quiz attempt for streak
